                 ...
                 const bytes& pt) const
{
  ...
  if (!aad.empty()) {
    if (1 != EVP_EncryptUpdate(
               ctx.get(), nullptr, &outlen, aad.data(), static_cast<int>(aad.size()))) {
      throw openssl_error();
    }
  }
  ...
  if (1 !=
      EVP_EncryptUpdate(
              ctx.get(), ct.data(), &outlen, pt.data(), static_cast<int>(pt.size()))) {
    throw openssl_error();
  }
  ...
  if (1 != EVP_CIPHER_CTX_ctrl(
             ctx.get(), EVP_CTRL_GCM_GET_TAG, static_cast<int>(tag_size), tag.data())) {
    throw openssl_error();
  }
                 ...
                 const bytes& ct) const
{
  ...
  if (1 != EVP_CIPHER_CTX_ctrl(
             ctx.get(), EVP_CTRL_GCM_SET_TAG, static_cast<int>(tag_size), tag.data())) {
    throw openssl_error();
  }
  ...
  if (!aad.empty()) {
    if (1 != EVP_DecryptUpdate(
               ctx.get(), nullptr, &out_size, aad.data(), static_cast<int>(aad.size()))) {
      throw openssl_error();
    }
  }
  ...
  if (1 != EVP_DecryptUpdate(
             ctx.get(), pt.data(), &out_size, ct.data(), static_cast<int>(inner_ct_size))) {
    throw openssl_error();
  }

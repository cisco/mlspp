...
tls::istream&
operator>>(tls::istream& str, TreeTestVectors::TestCase& obj)
{
  return str >> obj.credentials >> obj.trees;
}

tls::ostream&
operator<<(tls::ostream& str, const TreeTestVectors::TestCase& obj)
{
  return str << obj.credentials << obj.trees;
}
...
{
  return str >> obj.leaf_secrets >> obj.case_p256_p256 >>
